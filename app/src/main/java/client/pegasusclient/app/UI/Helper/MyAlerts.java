...
public class MyAlerts {
    ...
    public static void showAlertDialog(final Context aContext) {
        final AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(aContext.getApplicationContext(), android.R.style.Theme_Dialog));
        ...
        final Intent MainPegasusClientIntent = new Intent(aContext.getApplicationContext(), PegasusSettings.class);
